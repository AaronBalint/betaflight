...
// PG_GPS_CONFIG
...
#ifdef USE_GPS_RESCUE
    // PG_GPS_RESCUE
    { "gps_rescue_max_angle",       VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0,  70 }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t,  angle) },
    { "gps_rescue_return_alt",      VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 30, 200 }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, initialAltitudeM) },
    { "gps_rescue_approach_dist",   VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 20, 200 }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, descentDistanceM) },
    { "gps_rescue_home_alt",        VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 10, 50 }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, targetLandingAltitudeM) },
    //{ "gps_rescue_landing_dist",    VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 5, 50 }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, targetLandingDistanceM) },
    //{ "gps_rescue_ground_speed",    VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 10, 3000 }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, rescueGroundspeed) },
    ...
    //{ "gps_rescue_min_dth",         VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 10, 1000 }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, minRescueDth) },
...
#endif
    { "gps_rescue_cal_lat",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, gps_callibration_latitude)},
    { "gps_rescue_cal_lon",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, gps_callibration_longitude)},
    { "fplan_waypoints",      VAR_UINT8 | MASTER_VALUE, .config.minmaxUnsigned = { 0, FLIGHTPLAN_MAX_WAYPOINT_COUNT }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, total_waypoints) },
    { "fplan_lat_01",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lat_01)},
    { "fplan_lat_02",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lat_02)},
    { "fplan_lat_03",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lat_03)},
    { "fplan_lat_04",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lat_04)},
    { "fplan_lat_05",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lat_05)},
    { "fplan_lat_06",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lat_06)},
    { "fplan_lat_07",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lat_07)},
    { "fplan_lat_08",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lat_08)},
    { "fplan_lat_09",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lat_09)},
    { "fplan_lat_10",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lat_10)},
    { "fplan_lon_01",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lon_01)},
    { "fplan_lon_02",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lon_02)},
    { "fplan_lon_03",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lon_03)},
    { "fplan_lon_04",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lon_04)},
    { "fplan_lon_05",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lon_05)},
    { "fplan_lon_06",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lon_06)},
    { "fplan_lon_07",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lon_07)},
    { "fplan_lon_08",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lon_08)},
    { "fplan_lon_09",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lon_09)},
    { "fplan_lon_10",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_lon_10)},
    { "fplan_alt_01",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_alt_01)},
    { "fplan_alt_02",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_alt_02)},
    { "fplan_alt_03",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_alt_03)},
    { "fplan_alt_04",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_alt_04)},
    { "fplan_alt_05",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_alt_05)},
    { "fplan_alt_06",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_alt_06)},
    { "fplan_alt_07",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_alt_07)},
    { "fplan_alt_08",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_alt_08)},
    { "fplan_alt_09",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_alt_09)},
    { "fplan_alt_10",VAR_UINT8 | MASTER_VALUE | MODE_STRING, .config.string = {1, FLIGHTPLAN_DATA_LENGTH, STRING_FLAGS_NONE}, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, fp_alt_10)},
#endif
#endif
